...
# python devo_wrapper.py --datID 20190906 --demult minibar --samps 20190906_sample_list.txt --mbseqs 20190906_primerindex.txt --subset 500 --db Sept2019_Sanger_cytb.fasta
# python devo_wrapper.py --datID 20190909 --demult minibar --samps 20190909_sample_list.txt --mbseqs 20190909_primerindex.txt --subset 500 --db Sept2019_Sanger_cytb.fasta
# python devo_wrapper.py --datID 20190911 --demult minibar --samps 20190911_sample_list.txt --mbseqs 20190911_primerindex.txt --subset 500 --db Sept2019_Sanger_cytb.fasta
# python devo_wrapper.py --datID 20190911 --demult minibar --samps 20190913_sample_list.txt --mbseqs 20190913_primerindex.txt --subset 500 --db Sept2019_Sanger_cytb.fasta

# python devo_wrapper.py --datID 20190906 --demult minibar --samps 20190906_sample_list.txt --mbseqs 20190906_primerindex.txt --subset 5000 --db Sept2019_Sanger_cytb.fasta
# python devo_wrapper.py --datID 20190909 --demult minibar --samps 20190909_sample_list.txt --mbseqs 20190909_primerindex.txt --subset 5000 --db Sept2019_Sanger_cytb.fasta
# python devo_wrapper.py --datID 20190911 --demult minibar --samps 20190911_sample_list.txt --mbseqs 20190911_primerindex.txt --subset 5000 --db Sept2019_Sanger_cytb.fasta
# python devo_wrapper.py --datID 20190911 --demult minibar --samps 20190913_sample_list.txt --mbseqs 20190913_primerindex.txt --subset 5000 --db Sept2019_Sanger_cytb.fasta
...
# python devo_wrapper.py --datID 20190906 --demult qcat --samps 20190906_sample_list.txt --subset 500 --db Sept2019_Sanger_cytb.fasta
# python devo_wrapper.py --datID 20190909 --demult qcat --samps 20190909_sample_list.txt --subset 500 --db Sept2019_Sanger_cytb.fasta
# python devo_wrapper.py --datID 20190911 --demult qcat --samps 20190911_sample_list.txt --subset 500 --db Sept2019_Sanger_cytb.fasta
# python devo_wrapper.py --datID 20190911 --demult qcat --samps 20190913_sample_list.txt --subset 500 --db Sept2019_Sanger_cytb.fasta

# python devo_wrapper.py --datID 20190906 --demult qcat --samps 20190906_sample_list.txt --subset 5000 --db Sept2019_Sanger_cytb.fasta
# python devo_wrapper.py --datID 20190909 --demult qcat --samps 20190909_sample_list.txt --subset 5000 --db Sept2019_Sanger_cytb.fasta
# python devo_wrapper.py --datID 20190911 --demult qcat --samps 20190911_sample_list.txt --subset 5000 --db Sept2019_Sanger_cytb.fasta
# python devo_wrapper.py --datID 20190911 --demult qcat --samps 20190913_sample_list.txt --subset 5000 --db Sept2019_Sanger_cytb.fasta
